...
class CustomerServiceOrderPutControllerShould extends CustomersApplicationTestCase {
    ...
    void should_create_new_device_and_service_order_for_existent_service_and_device() throws Exception {
        ...
        assertRequestWithBody(
            "PUT",
            "/orders/31bf6a3c-2d59-4f87-801f-945fe101bd50/devices/" + deviceId,
            deviceOrder,
            CREATED);

        var servOrder = "{\"deviceId\":\""+deviceId+"\", \"customerId\":\"caa5c9ff-65b9-4f98-a3c3-043f4b2fa15e\"}";

        assertRequestWithBody(
            "PUT",
            "/orders/31bf6a3c-2d59-4f87-801f-945fe101bd50/service/" + serviceId,
            servOrder,
            CREATED);
    }
}
