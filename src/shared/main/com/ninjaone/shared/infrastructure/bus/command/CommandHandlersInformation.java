package com.ninjaone.shared.infrastructure.bus.command;
...
import com.ninjaone.shared.domain.bus.command.CommandNotRegisteredError;
...
public final class CommandHandlersInformation {
    ...
    public CommandHandlersInformation() {
        Reflections reflections = new Reflections("com.ninjaone");
